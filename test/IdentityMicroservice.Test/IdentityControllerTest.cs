...
namespace IdentityMicroservice.Test
{
        ...
        private readonly List<User> _users = new()
    {
        ...
        public IdentityControllerTest()
        {
            ...
            mockRepo
                ...
                .Returns(email => _users.FirstOrDefault(u => u.Email == (string)email[0]));

            mockRepo
                .When(x => x.InsertUser(Arg.Any<User>()))
                .Do(z => _users.Add((User)z[0]));
            ...
            _controller = new IdentityController
                          (mockRepo, new JwtBuilder(jwtOptions), new Encryptor());
        }
